...
The initial error is $2.575\times 10^6$ and the final error is $1.547\times 10^9$\footnote{The error is computed by the unnormalized error $0.5\Sigma_i(h_i(X_i)-z)^2/\sigma^2$ between a nonlinear factor graph and a trajectory of value nodes.}.
